...
def filter_by_currency(transactions: list[dict[str, Any]], code: str = None) -> Iterator[dict]:
    ...
    while True:
        yield None
transactions_by_code = filter_by_currency(transactions, code = "RUB")
#transactions_by_code = filter_by_currency(transactions1, code = "RUB")

# while True:
#     try:
#         print(next(transactions_by_code))
...
# try:
#     while True:
#         result.append(next(transactions_by_code))
# except StopIteration:
#     pass
