...
def test_filter_by_currency_USD(transaction_source):
    generator = filter_by_currency(transaction_source, "USD")
...
def test_filter_by_currency_RUB(transaction_source):
    generator = filter_by_currency(transaction_source, "RUB")
...
def test_filter_bu_currency_empty_list(empty_list):
